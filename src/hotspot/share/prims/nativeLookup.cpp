...
extern "C" {
  ...
  void JNICALL JVM_RegisterJWarmUpMethods(JNIEnv *env, jclass jwarmupclass);
#if INCLUDE_JVMCI
...
static JNINativeMethod lookup_special_native_methods[] = {
  ...
  { CC"Java_jdk_jwarmup_JWarmUp_registerNatives",                  NULL, FN_PTR(JVM_RegisterJWarmUpMethods)      },
#if INCLUDE_JVMCI
