...
# @test
# @summary test class loaded from source from different locations
# @run shell TestCustomClassLoader.sh
...
public class TmpTestMain {
  ...
  public static void main(String[] args) throws Exception {
    try {
      foo("dir1");
      bar("dir2");
      JWarmUp jwarmup = JWarmUp.getJWarmUp();
